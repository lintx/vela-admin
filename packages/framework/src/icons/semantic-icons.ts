...
export const adminSemanticIcons = [
  ...
  { name: 'format-list-bulleted', label: '长列表', usage: '超长菜单、列表型示例入口', phosphor: 'list-bullets', tabler: 'list-details' },
  ...
  { name: 'menu-2', label: '上下文菜单', usage: '上下文菜单示例、菜单面板入口', phosphor: 'list-bullets', tabler: 'menu-2' },
  { name: 'sortable', label: '拖动排序', usage: '拖动排序组件、排序示例入口', phosphor: 'sortable', tabler: 'sortable' },
  { name: 'drag-handle', label: '拖动手柄', usage: '排序手柄、可拖动区域', phosphor: 'drag-handle', tabler: 'drag-handle' },
  ...
  { name: 'pin-off', label: '取消固定', usage: '取消固定标签页', phosphor: 'pin-off', tabler: 'pinned-off' },
  { name: 'github', label: 'GitHub', usage: 'GitHub 仓库链接', phosphor: 'github', tabler: 'brand-github' },
  { name: 'link', label: '链接', usage: '复制链接、打开外部资源', phosphor: 'link', tabler: 'link' },
  { name: 'view', label: '查看', usage: '预览、查看详情', phosphor: 'view', tabler: 'eye' },
  { name: 'copy', label: '复制', usage: '复制内容、复制副本', phosphor: 'copy', tabler: 'copy' },
  { name: 'download', label: '下载', usage: '下载文件、导出资源', phosphor: 'download', tabler: 'download' },
  { name: 'focus-2', label: '聚焦', usage: '焦点区域、定位示例', phosphor: 'focus-2', tabler: 'focus-2' },
  { name: 'cursor-click', label: '点击', usage: '点击操作、指针交互示例', phosphor: 'cursor-click', tabler: 'pointer' },
  { name: 'text', label: '文本', usage: '文本区域、文本菜单示例', phosphor: 'text', tabler: 'text-size' },
